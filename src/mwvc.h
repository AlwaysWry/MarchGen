...
extern "C" __declspec(dllexport) int BuildInstance(string);
extern "C" __declspec(dllexport) void FreeMemory();
extern "C" __declspec(dllexport) void ResetRemoveCand();
extern "C" __declspec(dllexport) inline void Uncover(int);
extern "C" __declspec(dllexport) inline void Cover(int);
extern "C" __declspec(dllexport) void Add(int);
extern "C" __declspec(dllexport) void Remove(int);
extern "C" __declspec(dllexport) int UpdateTargetSize();
extern "C" __declspec(dllexport) int ChooseRemoveV1();
extern "C" __declspec(dllexport) int ChooseRemoveV2();
extern "C" __declspec(dllexport) int ChooseAddV(int, int,int);
extern "C" __declspec(dllexport) void UpdateBestSolution();
void RemoveRedundant();
extern "C" __declspec(dllexport) void ConstructVC();
extern "C" __declspec(dllexport) int CheckSolution();
//void ForgetEdgeWeights();
extern "C" __declspec(dllexport) void UpdateEdgeWeight();
extern "C" __declspec(dllexport) void LocalSearch();
extern "C" __declspec(dllexport) double TimeElapsed();
...
extern "C" __declspec(dllexport) int BuildInstance(string filename)
{
    string tmp;
    string sign;
    int v, e;
...
extern "C" __declspec(dllexport) inline void Uncover(int e)
{
    index_in_uncov_stack[e] = uncov_stack_fill_pointer;
    push(e, uncov_stack);
}

extern "C" __declspec(dllexport) inline void Cover(int e)
{
...
extern "C" __declspec(dllexport) void Add(int v)
{
    int i, e, n;
...
extern "C" __declspec(dllexport) void Remove(int v)
{
    int i, e, n;
    int edge_count = v_degree[v];
...
extern "C" __declspec(dllexport) int ChooseAddV(int update_v, int remove_v = 0, int remove_v2 = 0)
{
    int i, v;
    int add_v = 0;
    double improvement = 0.0;
...
extern "C" __declspec(dllexport) void ForgetEdgeWeights()
{
    int v, e;
